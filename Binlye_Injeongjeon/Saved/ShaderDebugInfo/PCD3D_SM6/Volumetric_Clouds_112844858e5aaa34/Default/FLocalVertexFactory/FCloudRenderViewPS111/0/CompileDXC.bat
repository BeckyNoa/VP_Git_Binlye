...
%DXC% -HV 2018 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T ps_6_6 -E MainPS -Fc VolumetricCloud.d3dasm -Fo VolumetricCloud.dxil VolumetricCloud.usf
:END
PAUSE
